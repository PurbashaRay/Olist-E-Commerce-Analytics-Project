...
olist_order_items_dataset.csv – item-level pricing, freight cost, seller and product IDs

olist_customers_dataset.csv – customer ID and location (city, state, zip code)

olist_sellers_dataset.csv – seller ID and location

olist_products_dataset.csv – product ID and category

olist_order_payments_dataset.csv – order ID, payment method, instalments, and payment value

olist_order_reviews_dataset.csv – order ID, review score (1–5)
